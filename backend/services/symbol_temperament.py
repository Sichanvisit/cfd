...
def resolve_probe_scene_direction(scene_id: str = "") -> str:
...
_SCENE_PROBE_PLAN = {
    ...
    "nas_clean_confirm_probe": {
        "scene_id": "nas_clean_confirm_probe",
        "promotion_bias": "clean_confirm",
        "min_confirm_fake_gap": 0.04,
        "min_continue_fail_gap": 0.00,
        "min_persistence": 0.20,
        "min_belief": 0.54,
        "min_pair_gap": 0.15,
        "min_candidate_support": 0.32,
        "min_action_confirm_score": 0.24,
        "min_streak": 1,
        "max_side_barrier": 0.40,
        "min_energy_ready": 0.50,
        "min_core_score": 0.54,
        "recommended_size_multiplier": 0.45,
        "recommended_entry_stage": "balanced",
        "confirm_add_size_multiplier": 1.00,
