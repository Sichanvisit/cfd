"""Build SA4b shadow divergence audit outputs."""
...
from backend.services.shadow_auto_divergence_audit import (  # noqa: E402
    build_shadow_auto_divergence_audit,
    render_shadow_auto_divergence_audit_markdown,
)
...
def _default_csv_output_path() -> Path:
    return ROOT / "data" / "analysis" / "shadow_auto" / "shadow_divergence_audit_latest.csv"


def _default_json_output_path() -> Path:
    return ROOT / "data" / "analysis" / "shadow_auto" / "shadow_divergence_audit_latest.json"


def _default_md_output_path() -> Path:
    return ROOT / "data" / "analysis" / "shadow_auto" / "shadow_divergence_audit_latest.md"
...
def main() -> int:
    ...
    md_output_path.write_text(render_shadow_auto_divergence_audit_markdown(summary, frame), encoding="utf-8")
