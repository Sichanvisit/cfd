"""Build latest path-leg snapshot artifact for PA1 instrumentation."""
...
from backend.services.path_leg_runtime import (  # noqa: E402
...
def _default_json_output_path() -> Path:
    return ROOT / "data" / "analysis" / "shadow_auto" / "path_leg_snapshot_latest.json"
...
def main(argv: list[str] | None = None) -> int:
    ...
    snapshot, summary = build_path_leg_snapshot(
