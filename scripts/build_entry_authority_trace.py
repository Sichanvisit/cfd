"""Build latest entry authority trace outputs."""
...
from backend.services.entry_authority_trace import (  # noqa: E402
    build_entry_authority_trace,
    render_entry_authority_trace_markdown,
)
...
def _default_csv_output_path() -> Path:
    return ROOT / "data" / "analysis" / "shadow_auto" / "entry_authority_trace_latest.csv"


def _default_json_output_path() -> Path:
    return ROOT / "data" / "analysis" / "shadow_auto" / "entry_authority_trace_latest.json"


def _default_md_output_path() -> Path:
    return ROOT / "data" / "analysis" / "shadow_auto" / "entry_authority_trace_latest.md"
...
def main() -> int:
    ...
    frame, summary = build_entry_authority_trace(
    ...
    md_output_path.write_text(render_entry_authority_trace_markdown(summary, frame), encoding="utf-8")
