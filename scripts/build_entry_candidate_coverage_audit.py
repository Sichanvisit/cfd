"""Build latest AI2 candidate coverage audit outputs."""
...
from backend.services.entry_candidate_coverage_audit import (  # noqa: E402
    build_entry_candidate_coverage_audit,
    render_entry_candidate_coverage_audit_markdown,
)
...
def _default_csv_output_path() -> Path:
    return ROOT / "data" / "analysis" / "shadow_auto" / "entry_candidate_coverage_audit_latest.csv"


def _default_json_output_path() -> Path:
    return ROOT / "data" / "analysis" / "shadow_auto" / "entry_candidate_coverage_audit_latest.json"


def _default_md_output_path() -> Path:
    return ROOT / "data" / "analysis" / "shadow_auto" / "entry_candidate_coverage_audit_latest.md"
...
def main() -> int:
    ...
    markdown = render_entry_candidate_coverage_audit_markdown(summary, frame)
