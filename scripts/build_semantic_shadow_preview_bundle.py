"""Train a preview semantic shadow bundle from proxy datasets."""
...
from backend.services.semantic_shadow_preview_bundle import (  # noqa: E402
    DEFAULT_DATASET_DIR,
    DEFAULT_OUTPUT_DIR,
    build_semantic_shadow_preview_bundle,
    render_semantic_shadow_preview_bundle_markdown,
)


def _default_csv_output_path() -> Path:
    return ROOT / "data" / "analysis" / "shadow_auto" / "semantic_shadow_preview_bundle_latest.csv"
...
def _default_md_output_path() -> Path:
    return ROOT / "data" / "analysis" / "shadow_auto" / "semantic_shadow_preview_bundle_latest.md"
...
def main() -> int:
    ...
    md_output_path.write_text(
        render_semantic_shadow_preview_bundle_markdown(summary, frame),
        encoding="utf-8",
    )
    print(
        json.dumps(
