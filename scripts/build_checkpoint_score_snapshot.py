"""Build latest checkpoint score snapshot artifact for PA4 instrumentation."""
...
from backend.services.path_checkpoint_scoring import (  # noqa: E402
    build_checkpoint_score_snapshot,
    default_checkpoint_score_snapshot_path,
)
...
def main(argv: list[str] | None = None) -> int:
    ...
    parser.add_argument("--json-output-path", default=str(default_checkpoint_score_snapshot_path()))
    args = parser.parse_args(argv)

    snapshot, summary = build_checkpoint_score_snapshot(
