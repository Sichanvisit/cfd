...
from backend.services.path_checkpoint_pa8_historical_replay import (  # noqa: E402
...
def main(argv: list[str] | None = None) -> int:
    ...
    payload = build_checkpoint_pa8_historical_replay_board(_load_csv(args.resolved_dataset_path))
    write_checkpoint_pa8_historical_replay_outputs(payload)
