"""Build SA5a first divergence run outputs."""
...
from backend.services.shadow_auto_first_divergence_run import (  # noqa: E402
    build_shadow_auto_first_divergence_run,
    render_shadow_auto_first_divergence_run_markdown,
)
from backend.services.shadow_auto_threshold_sweep import load_shadow_auto_threshold_sweep_frame  # noqa: E402
...
def _default_threshold_sweep_path() -> Path:
...
def _default_md_output_path() -> Path:
    return ROOT / "data" / "analysis" / "shadow_auto" / "shadow_first_divergence_run_latest.md"
...
def main() -> int:
    ...
    parser.add_argument("--threshold-sweep-path", default=str(_default_threshold_sweep_path()))
    ...
    threshold_sweep = load_shadow_auto_threshold_sweep_frame(args.threshold_sweep_path)
    ...
    md_output_path.write_text(render_shadow_auto_first_divergence_run_markdown(summary, frame), encoding="utf-8")
