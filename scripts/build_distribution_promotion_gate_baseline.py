"""Build latest distribution-based promotion gate baseline artifacts."""
...
from backend.services.distribution_promotion_gate_baseline import (  # noqa: E402
...
def _default_csv_output_path() -> Path:
    return ROOT / "data" / "analysis" / "shadow_auto" / "distribution_promotion_gate_baseline_latest.csv"


def _default_json_output_path() -> Path:
    return ROOT / "data" / "analysis" / "shadow_auto" / "distribution_promotion_gate_baseline_latest.json"


def _default_md_output_path() -> Path:
    return ROOT / "data" / "analysis" / "shadow_auto" / "distribution_promotion_gate_baseline_latest.md"
