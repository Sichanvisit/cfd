"""Build latest checkpoint action eval artifact for PA5 instrumentation."""
...
def main(argv: list[str] | None = None) -> int:
    ...
    parser.add_argument("--json-output-path", default=str(default_checkpoint_action_eval_path()))
    ...
    json_output_path.write_text(
        json.dumps(
            {"summary": summary, "rows": eval_frame.to_dict(orient="records")},
            ensure_ascii=False,
            indent=2,
        ),
        encoding="utf-8",
