"""
Build the semantic shadow bundle bootstrap/readiness report.

Usage:
  python scripts/build_semantic_shadow_bundle_bootstrap.py
"""
...
from backend.services.semantic_shadow_bundle_bootstrap import (  # noqa: E402
    build_semantic_shadow_bundle_bootstrap,
    render_semantic_shadow_bundle_bootstrap_markdown,
)


def _default_csv_output_path() -> Path:
    return ROOT / "data" / "analysis" / "shadow_auto" / "semantic_shadow_bundle_bootstrap_latest.csv"


def _default_json_output_path() -> Path:
    return ROOT / "data" / "analysis" / "shadow_auto" / "semantic_shadow_bundle_bootstrap_latest.json"


def _default_md_output_path() -> Path:
    return ROOT / "data" / "analysis" / "shadow_auto" / "semantic_shadow_bundle_bootstrap_latest.md"
...
def main() -> int:
    ...
    md_output_path.write_text(
        render_semantic_shadow_bundle_bootstrap_markdown(summary, frame),
        encoding="utf-8",
    )
