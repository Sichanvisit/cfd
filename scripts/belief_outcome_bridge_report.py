...
Usage:
  python scripts/belief_outcome_bridge_report.py
"""
...
from backend.services.belief_outcome_bridge import (  # noqa: E402
    write_belief_outcome_bridge_report,
)
...
def _default_markdown_output_path() -> Path:
    return ROOT / "data" / "analysis" / "belief" / "belief_outcome_bridge_latest.md"
...
def main() -> int:
    ...
    report = write_belief_outcome_bridge_report(
        ...
        json.dumps(
            {
                ...
                "weak_usable_rows": summary.get("weak_usable_rows", 0),
                "candidate_gate_usable_rows": summary.get("candidate_gate_usable_rows", 0),
