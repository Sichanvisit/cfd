"""Build latest countertrend DOWN bootstrap validation artifacts."""
...
from backend.services.countertrend_down_bootstrap_validation import (  # noqa: E402
...
def _default_csv_output_path() -> Path:
    return ROOT / "data" / "analysis" / "shadow_auto" / "countertrend_down_bootstrap_validation_latest.csv"


def _default_json_output_path() -> Path:
    return ROOT / "data" / "analysis" / "shadow_auto" / "countertrend_down_bootstrap_validation_latest.json"


def _default_md_output_path() -> Path:
    return ROOT / "data" / "analysis" / "shadow_auto" / "countertrend_down_bootstrap_validation_latest.md"
...
def main() -> int:
    ...
    frame, summary = build_countertrend_down_bootstrap_validation(
