"""Build latest initial-entry label resolution queue artifacts."""
...
from backend.services.initial_entry_label_resolution_queue import (  # noqa: E402
    build_initial_entry_label_resolution_queue,
    render_initial_entry_label_resolution_queue_markdown,
)
...
def main() -> int:
    ...
    parser.add_argument("--csv-output-path", default=str(_default_shadow_auto_dir() / "initial_entry_label_resolution_queue_latest.csv"))
    parser.add_argument("--json-output-path", default=str(_default_shadow_auto_dir() / "initial_entry_label_resolution_queue_latest.json"))
    parser.add_argument("--md-output-path", default=str(_default_shadow_auto_dir() / "initial_entry_label_resolution_queue_latest.md"))
    ...
    markdown = render_initial_entry_label_resolution_queue_markdown(summary, frame)
