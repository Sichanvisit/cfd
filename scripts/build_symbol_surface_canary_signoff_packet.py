"""Build latest generic symbol-surface canary signoff packet artifacts."""
...
from backend.services.symbol_surface_canary_signoff_packet import (  # noqa: E402
    build_symbol_surface_canary_signoff_packet,
    render_symbol_surface_canary_signoff_packet_markdown,
)
...
def main() -> int:
    ...
    parser.add_argument("--csv-output-path", default=str(_default_shadow_auto_dir() / "symbol_surface_canary_signoff_packet_latest.csv"))
    parser.add_argument("--json-output-path", default=str(_default_shadow_auto_dir() / "symbol_surface_canary_signoff_packet_latest.json"))
    parser.add_argument("--md-output-path", default=str(_default_shadow_auto_dir() / "symbol_surface_canary_signoff_packet_latest.md"))
    ...
    markdown = render_symbol_surface_canary_signoff_packet_markdown(summary, frame)
