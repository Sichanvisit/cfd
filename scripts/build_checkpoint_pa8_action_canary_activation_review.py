...
from backend.services.path_checkpoint_pa8_action_canary_activation_review import (  # noqa: E402
    build_checkpoint_pa8_nas100_action_only_canary_activation_review,
    default_checkpoint_pa8_nas100_action_only_canary_activation_review_json_path,
    default_checkpoint_pa8_nas100_action_only_canary_activation_review_markdown_path,
...
def main(argv: list[str] | None = None) -> int:
    ...
    parser.add_argument(
        "--json-output-path",
        default=str(default_checkpoint_pa8_nas100_action_only_canary_activation_review_json_path()),
    )
    parser.add_argument(
        "--markdown-output-path",
        default=str(default_checkpoint_pa8_nas100_action_only_canary_activation_review_markdown_path()),
    )
    ...
    markdown = render_checkpoint_pa8_nas100_action_only_canary_activation_review_markdown(payload)
