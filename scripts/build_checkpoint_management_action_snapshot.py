"""Build latest checkpoint management-action snapshot artifact for PA6."""
...
def main(argv: list[str] | None = None) -> int:
    ...
    parser.add_argument("--json-output-path", default=str(default_checkpoint_management_action_snapshot_path()))
    args = parser.parse_args(argv)

    rows, summary = build_checkpoint_management_action_snapshot(
