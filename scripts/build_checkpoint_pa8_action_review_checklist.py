...
from backend.services.path_checkpoint_pa8_action_review_checklist import (  # noqa: E402
    ...
    default_checkpoint_pa8_action_review_checklist_markdown_path,
...
def main(argv: list[str] | None = None) -> int:
    ...
    parser.add_argument("--pa8-action-review-packet-path", default=str(_default_shadow_auto_dir() / "checkpoint_pa8_action_review_packet_latest.json"))
    parser.add_argument("--json-output-path", default=str(default_checkpoint_pa8_action_review_checklist_json_path()))
    parser.add_argument("--markdown-output-path", default=str(default_checkpoint_pa8_action_review_checklist_markdown_path()))
    ...
    markdown = render_checkpoint_pa8_action_review_checklist_markdown(payload)
