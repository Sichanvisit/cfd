"""Build latest upper-reversal breakout conflict validation artifacts."""
...
from backend.services.upper_reversal_breakout_conflict_validation import (  # noqa: E402
...
def _default_csv_output_path() -> Path:
    return (
        ...
        / "analysis"
        / "shadow_auto"
        / "upper_reversal_breakout_conflict_validation_latest.csv"
    )
...
def _default_json_output_path() -> Path:
    return (
        ...
        / "analysis"
        / "shadow_auto"
        / "upper_reversal_breakout_conflict_validation_latest.json"
    )
...
def _default_md_output_path() -> Path:
    return (
        ...
        / "analysis"
        / "shadow_auto"
        / "upper_reversal_breakout_conflict_validation_latest.md"
    )
...
def main() -> int:
    ...
    parser.add_argument("--replay-recent-limit", type=int, default=1200)
    ...
    frame, summary = build_upper_reversal_breakout_conflict_validation(
        ...
        replay_recent_limit=max(1, int(args.replay_recent_limit)),
    )
