"""Build BTC initial-entry review canary signoff packet artifacts."""
...
from backend.services.btc_initial_entry_canary_signoff_packet import (  # noqa: E402
...
def main() -> int:
    ...
    parser.add_argument("--csv-output-path", default=str(_default_shadow_auto_dir() / "btc_initial_entry_canary_signoff_packet_latest.csv"))
    parser.add_argument("--json-output-path", default=str(_default_shadow_auto_dir() / "btc_initial_entry_canary_signoff_packet_latest.json"))
    parser.add_argument("--md-output-path", default=str(_default_shadow_auto_dir() / "btc_initial_entry_canary_signoff_packet_latest.md"))
