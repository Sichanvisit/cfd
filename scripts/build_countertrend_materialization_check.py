"""Build latest fresh countertrend materialization check artifacts."""
...
from backend.services.countertrend_materialization_check import (  # noqa: E402
...
def _default_csv_output_path() -> Path:
    return ROOT / "data" / "analysis" / "shadow_auto" / "countertrend_materialization_check_latest.csv"


def _default_json_output_path() -> Path:
    return ROOT / "data" / "analysis" / "shadow_auto" / "countertrend_materialization_check_latest.json"


def _default_md_output_path() -> Path:
    return ROOT / "data" / "analysis" / "shadow_auto" / "countertrend_materialization_check_latest.md"
...
def main() -> int:
    ...
    frame, summary = build_countertrend_materialization_check(
