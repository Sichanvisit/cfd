...
from backend.services.path_checkpoint_pa8_action_canary_monitoring_packet import (  # noqa: E402
    build_checkpoint_pa8_nas100_action_only_canary_monitoring_packet,
    default_checkpoint_pa8_nas100_action_only_canary_monitoring_packet_json_path,
    default_checkpoint_pa8_nas100_action_only_canary_monitoring_packet_markdown_path,
...
def main(argv: list[str] | None = None) -> int:
    ...
    parser.add_argument(
        "--json-output-path",
        default=str(default_checkpoint_pa8_nas100_action_only_canary_monitoring_packet_json_path()),
    )
    parser.add_argument(
        "--markdown-output-path",
        default=str(default_checkpoint_pa8_nas100_action_only_canary_monitoring_packet_markdown_path()),
    )
    ...
    markdown = render_checkpoint_pa8_nas100_action_only_canary_monitoring_packet_markdown(payload)
